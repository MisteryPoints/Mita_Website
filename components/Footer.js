...
export default function Footer() {
  ...
  return (
    <footer className='relative bottom-0 w-full bg-[#214194] '>
      <div className="h-[90px] w-full flex items-center justify-center"> 
        <Link href="https://www.facebook.com/CongregacionMita" className=''>
          <div className="inline-block h-[60px] w-[60px] float-left my-0 mx-[5px] overflow-hidden bg-white rounded-[50px] cursor-pointer shadow-md ease-out transition-all duration-300 hover:w-[200px]"  onMouseEnter={() => setFaceActive(true)} onMouseLeave={() => setFaceActive(false)}>
        ...
        <Link href="https://www.youtube.com/@CongregacionMitaInc/videos" className=''>
          <div className="inline-block h-[60px] w-[60px] float-left my-0 mx-[5px] overflow-hidden bg-white rounded-[50px] cursor-pointer shadow-md ease-out transition-all duration-300 hover:w-[200px]" onMouseEnter={() => setYouActive(true)} onMouseLeave={() => setYouActive(false)}>
        ...
        <Link href="#" className=''>
          <div className="inline-block h-[60px] w-[60px] float-left my-0 mx-[5px] overflow-hidden bg-white rounded-[50px] cursor-pointer shadow-md ease-out transition-all duration-300 hover:w-[200px]"  onMouseEnter={() => setContActive(true)} onMouseLeave={() => setContActive(false)}>
      ...
      <div className="w-[100vw] text-center text-lg text-white">
